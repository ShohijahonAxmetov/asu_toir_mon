                    ...
                    <table class="table table-sm table-hover mb-0">
                        ...
                        @foreach ($applications as $key => $item)
                            <tr>
                                ...
                                <td class="{{ $item->orderResource ? ($item->orderResource->executionStatuse->id == 6 ? 'bg-success' : '') : '' }} fw-bold h1">{{ $item->orderResource ? ($item->orderResource->executionStatuse->id == 6 ? '+' : '') : '' }}</td>
                                <td class="{{ $item->orderResource ? ($item->orderResource->executionStatuse->id == 8 ? 'bg-success' : '') : '' }} fw-bold h1">{{ $item->orderResource ? ($item->orderResource->executionStatuse->id == 8 ? '+' : '') : '' }}</td>
