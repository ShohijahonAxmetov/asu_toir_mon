                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" required class="form-control @error('planned') is-invalid @enderror" name="planned" value="{{ old('planned') ?? $detail->planned ?? null }}" id="planned" placeholder="Плановая дата...">
                                            @error('planned')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control mb-4 @error('type_technical_inspection_id') is-invalid @enderror" name="type_technical_inspection_id">
                                                @foreach ($type_technical_inspections as $key => $item)
                                                    <option value="{{ $item->id }}" {{ old('type_technical_inspection_id', $detail->type_technical_inspection_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
