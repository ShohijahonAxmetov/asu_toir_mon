                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="parent_id" class="form-label">Подразделения</label>
                                <select class="form-control @error('parent_id') is-invalid @enderror" name="parent_id" data-choices>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0">
                        ...
                        @foreach ($departments as $key => $item)
                            <tr>
                                <th scope="row" style="width: 100px">{{ $departments->firstItem() + $key }}</th>
                                <td>
