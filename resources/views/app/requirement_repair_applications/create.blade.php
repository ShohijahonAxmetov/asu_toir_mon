    ...
    <div class="header">
        <div class="container-fluid">
            ...
            'datas' => [
                [
                    'active' => false,
                    'url' => route($route_name_main.'.index'),
                    'name' => $title_main,
                    'disabled' => false
                ],
                [
                        ...
                        <form method="post" action="{{ route($route_name . '.store') }}" enctype="multipart/form-data" id="add">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <label for="warehouse_number" class="form-label required">Номер склада</label>
                                        <input type="text" class="form-control @error('warehouse_number') is-invalid @enderror" name="warehouse_number" value="{{ old('warehouse_number') }}" id="warehouse_number" placeholder="Номер склада..." required>
                            ...
                            <input type="hidden" name="repair_application_id" value="{{$id_application}}">
