        ...
        <div class="row">
            <div class="col-8">
                <div class="card mw-50">
                    <div class="card-body">
                        <form method="post" action="{{ route($route_parameter.'.qualifications.store', ['tech_operation' => $techOperation]) }}" id="add">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mb-4 @error('qualification_id') is-invalid @enderror" name="qualification_id" required>
                                            @foreach ($qualifications as $item)
                                                <option value="{{ $item->id }}" {{ old('qualification_id') == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
