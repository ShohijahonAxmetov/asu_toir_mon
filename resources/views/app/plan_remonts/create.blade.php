                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mb-4 @error('remont_type_id') is-invalid @enderror" name="remont_type_id" required>
                                            @foreach ($remont_types as $key => $item)
                                                <option value="{{ $item->id }}" {{ old('remont_type_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('remont_begin') is-invalid @enderror" name="remont_begin" value="{{ old('remont_begin') }}" id="remont_begin" placeholder="Дата начала...">
                                        @error('remont_begin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('remont_end') is-invalid @enderror" name="remont_end" value="{{ old('remont_end') }}" id="remont_end" placeholder="Дата окончания...">
                                        @error('remont_end')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
